...
contract UpgradeDKG is Script {
    function run() external view {
        ...
        bytes memory scheduleBatchData = abi.encodeWithSelector(
            TimelockController.scheduleBatch.selector,
            targets,
            values,
            payloads,
            bytes32(0), // predecessor
            keccak256("UPGRADE_DKG_CDR_BATCH"), // salt
            minDelay
        );
        ...
        console2.logBytes(scheduleBatchData);
    }
