...
/// @title ReceiveOwnershipIPTokenStaking
/// @notice Generates json files with the timelocked operations to receive the ownership of IPTokenStaking from the old timelock
contract ReceiveOwnershipIPTokenStaking is TimelockOperations {
