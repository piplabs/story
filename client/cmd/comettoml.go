...
// Note: we copy the default config template from cometbft(https://github.com/cometbft/cometbft/blob/v0.38.9/config/toml.go) here
// to support the custom `[mempool] type` config.
//
//nolint:dupword // This is a copy of the default cometbft config template.
