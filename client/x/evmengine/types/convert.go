...
func WithdrawalToProto(w *ethtypes.Withdrawal) (WithdrawalEVM, error) {
	if w == nil {
		return WithdrawalEVM{}, errors.New("nil withdrawal")
	}

	return WithdrawalEVM{
		Index:          w.Index,
...
func WithdrawalFromProto(w WithdrawalEVM) *ethtypes.Withdrawal {
