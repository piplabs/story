...
func (m *MockDKGKeeper) Registered(ctx context.Context, msgSender common.Address, codeCommitment [32]byte, round uint32, startBlockHeight *big.Int, startBlockHash, enclaveType [32]byte, dkgPubKey, commPubKey, enclaveReport []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Registered", ctx, msgSender, codeCommitment, round, startBlockHeight, startBlockHash, enclaveType, dkgPubKey, commPubKey, enclaveReport)
	ret0, _ := ret[0].(error)
	return ret0
}

// Registered indicates an expected call of Registered.
func (mr *MockDKGKeeperMockRecorder) Registered(ctx, msgSender, codeCommitment, round, startBlockHeight, startBlockHash, enclaveType, dkgPubKey, commPubKey, enclaveReport any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Registered", reflect.TypeOf((*MockDKGKeeper)(nil).Registered), ctx, msgSender, codeCommitment, round, startBlockHeight, startBlockHash, enclaveType, dkgPubKey, commPubKey, enclaveReport)
}
...
func (m *MockDKGKeeper) UpgradeCancelled(ctx context.Context, upgradeVersion string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpgradeCancelled", ctx, upgradeVersion)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpgradeCancelled indicates an expected call of UpgradeCancelled.
func (mr *MockDKGKeeperMockRecorder) UpgradeCancelled(ctx, upgradeVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpgradeCancelled", reflect.TypeOf((*MockDKGKeeper)(nil).UpgradeCancelled), ctx, upgradeVersion)
}

// UpgradeScheduled mocks base method.
func (m *MockDKGKeeper) UpgradeScheduled(ctx context.Context, activationHeight int64, upgradeVersion string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpgradeScheduled", ctx, activationHeight, upgradeVersion)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpgradeScheduled indicates an expected call of UpgradeScheduled.
func (mr *MockDKGKeeperMockRecorder) UpgradeScheduled(ctx, activationHeight, upgradeVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpgradeScheduled", reflect.TypeOf((*MockDKGKeeper)(nil).UpgradeScheduled), ctx, activationHeight, upgradeVersion)
}
