...
// Source: ../client/x/mint/types/expected_keepers.go
//
// Generated by this command:
//
//	mockgen -source=../client/x/mint/types/expected_keepers.go -package testutil -destination ../client/x/mint/testutil/expected_keepers_mocks.go
//
...
func (m *MockAccountKeeper) SetModuleAccount(ctx context.Context, moduleAccount types.ModuleAccountI) {
	m.ctrl.T.Helper()
