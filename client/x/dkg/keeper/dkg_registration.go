...
func (k *Keeper) updateDKGRegistrationStatus(ctx context.Context, codeCommitment [32]byte, round uint32, validatorAddr common.Address, pubKeyShare []byte, status types.DKGRegStatus) error {
