...
func P2Cases() []TestCase {
	...
	// IT-CDR-04 .. IT-CDR-08
	list = append(list,
		TestCase{ID: "IT-CDR-04", Priority: "P2", Description: "FeeCollected amount=0: no AddCDRFeeToPool", Expected: "zero-fee event path", NeedsRoundWait: true, Run: runIT_CDR_04},
		TestCase{ID: "IT-CDR-05", Priority: "P2", Description: "Pool balance < refund amount: error", Expected: "pool underflow error", NeedsRoundWait: true, Run: runIT_CDR_05},
		...
		TestCase{ID: "IT-CDR-07", Priority: "P2", Description: "Total submit count=0, pool>0: no SendCoins", Expected: "zero-submit-count path, no SendCoins", NeedsRoundWait: true, Run: runIT_CDR_07},
		TestCase{ID: "IT-CDR-08", Priority: "P2", Description: "E2E: CDR write/read + partial decryption + distributeCDRRewardPool", Expected: "full CDR lifecycle executed", NeedsRoundWait: true, Run: runIT_CDR_08},
	)
	return list
}
