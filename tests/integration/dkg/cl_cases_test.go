...
func CLCases() []TestCase {
	...
	list = append(list,
		...
		TestCase{ID: "CL-CDR-03", Priority: "P1", Description: "Multiple CDR read/write cycles within same round", Expected: "all vaults work independently", NeedsRoundWait: true, Run: runCL_CDR_03},
	)
	...
	list = append(list,
		...
		TestCase{ID: "CL-PS-05", Priority: "P2", Description: "Extra partial after threshold → stored, no double reward", NeedsRoundWait: true, Run: runCL_PS_05},
	...
	list = append(list,
		TestCase{ID: "CL-FLUSH-01", Priority: "P2", Description: "[H-04] No cross-round data contamination", NeedsRoundWait: true, Run: runCL_FLUSH_01},
	)

	// ─── CL-AUDIT: Audit-Driven Regression ───
	list = append(list,
		TestCase{ID: "CL-AUDIT-01", Priority: "P1", Description: "[STOR-28] CDR decrypt works >1min after Active", NeedsRoundWait: true, Run: runCL_AUDIT_01},
		...
		TestCase{ID: "CL-AUDIT-04", Priority: "P1", Description: "[STOR-9] CDR read path alive during Active", NeedsRoundWait: true, Run: runCL_AUDIT_04},
		TestCase{ID: "CL-AUDIT-05", Priority: "P2", Description: "[STOR-16] LatestActiveRound updated at transition", NeedsRoundWait: true, Run: runCL_AUDIT_05},
		TestCase{ID: "CL-AUDIT-06", Priority: "P2", Description: "[STOR-22] Finalization events at boundary processed", NeedsRoundWait: true, Run: runCL_AUDIT_06},
	)
