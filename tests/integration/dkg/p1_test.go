...
func p1BeginBlockerCases() []TestCase {
	return []TestCase{
		{ID: "IT-BB-01", Priority: "P2", Description: "height < dkgStartBlock: BeginBlocker return nil", Expected: "no round exists", Run: runIT_BB_01},
		{ID: "IT-BB-02", Priority: "P0", Description: "latestRound == nil: InitiateDKGRound(ctx, false)", Expected: "stage is valid (Registration/Dealing/Finalization/Active/Failed)", Run: runIT_BB_02},
		{ID: "IT-BB-03", Priority: "P0", Description: "Pending upgrade + height >= ActivationHeight", Expected: "IsUpgrade=true after activation", Run: runIT_BB_03},
		{ID: "IT-BB-04", Priority: "P0", Description: "Stage=Registration, elapsed >= RegistrationPeriod → Dealing", Expected: "stage >= Dealing", Run: runIT_BB_04, NeedsRoundWait: true},
		{ID: "IT-BB-05", Priority: "P0", Description: "Stage=Dealing → Finalization", Expected: "stage=Finalization", Run: runIT_BB_05, NeedsRoundWait: true},
		{ID: "IT-BB-06", Priority: "P0", Description: "Stage=Finalization → Active", Expected: "stage=Active", Run: runIT_BB_06, NeedsRoundWait: true},
		{ID: "IT-BB-07", Priority: "P2", Description: "Stage=Active, elapsed >= ActiveEnd → new round", Expected: "new round created, stage transitioned", Run: runIT_BB_07, NeedsRoundWait: true},
		{ID: "IT-BB-08", Priority: "P2", Description: "Stage transition time not reached: no transition", Expected: "stage unchanged within polling interval", Run: runIT_BB_08},
		{ID: "IT-BB-09", Priority: "P2", Description: "Pending upgrade, height < ActivationHeight: no activation", Expected: "IsUpgrade=false, height < activationHeight", Run: runIT_BB_09},
		{ID: "IT-BB-10", Priority: "P2", Description: "No pending upgrade: hasPendingUpgradeActivation returns nil", Expected: "IsUpgrade=false", Run: runIT_BB_10},
	}
}
...
func p1RegistrationCases() []TestCase {
	...
	// 精确匹配文档 ID
	cases = []TestCase{
		{ID: "IT-REG-01", Priority: "P0", Description: "First round: round 1, Stage=Registration, IsResharing=false", Expected: "round >= 1, IsResharing=false, ActiveValSet populated", Run: runIT_REG_01},
		{ID: "IT-REG-02", Priority: "P0", Description: "Previous round ended: new round IsResharing=true", Expected: "round >= 2, IsResharing=true or IsUpgrade=true", Run: runIT_REG_02},
		...
		{ID: "IT-REG-08", Priority: "P2", Description: "[defensive] Stage != Registration: return", Expected: "defensive — unit test only, unreachable in e2e", Run: runIT_REG_08},
		{ID: "IT-REG-09", Priority: "P2", Description: "[defensive] dkgSvcRunning true: return", Expected: "defensive — unit test only, Go concurrency lock", Run: runIT_REG_09},
...
func p1DealingCases() []TestCase {
	...
	list = append(list, TestCase{ID: "IT-DL-01", Priority: "P0", Description: "Verified >= MinReq: BeginDealing", Expected: "stage >= Dealing, Verified >= MinReq", Run: runIT_DL_01, NeedsRoundWait: true})
	...
	list = append(list, TestCase{ID: "IT-DL-04", Priority: "P2", Description: "[defensive] Stage != Dealing: handleDKGDealing returns early", Expected: "defensive — unit test only, unreachable in e2e", Run: runIT_DL_04})
	list = append(list, TestCase{ID: "IT-DL-05", Priority: "P2", Description: "[defensive] dkgSvcRunning true: concurrent call ignored", Expected: "defensive — unit test only, Go concurrency lock", Run: runIT_DL_05})
	...
	for i := 18; i <= 35; i++ {
		...
		list = append(list, TestCase{ID: id, Priority: "P2", Description: fmt.Sprintf("[implicit] VE/Deal internal logic case %d", i), Expected: "implicit — VE internal, verified by round progression, unit test recommended", Run: verifyRoundProgressedFunc})
	}
	return list
}
...
func p1FinalizationCases() []TestCase {
	...
	// 只注册有实现的 case
	list = append(list, TestCase{ID: "IT-FN-01", Priority: "P0", Description: "BeginFinalization: emit, go handleDKGFinalization", Expected: "stage=Finalization, Finalized registrations exist or stage=Active", Run: runIT_FN_01, NeedsRoundWait: true})
	...
	list = append(list, TestCase{ID: "IT-FN-04", Priority: "P0", Description: "callTEEFinalizeDKG succeeds", Expected: "log contains 'finalization phase complete'", Run: runIT_FN_04})
	...
	for i := 15; i <= 19; i++ {
		...
		list = append(list, TestCase{ID: id, Priority: "P2", Description: fmt.Sprintf("[implicit] Finalization internal logic case %d", i), Expected: "implicit — verified by round progression, unit test recommended", Run: verifyRoundProgressedFunc})
	}
	return list
}
...
func p1ActiveSkipE2ECases() []TestCase {
	return []TestCase{
		...
		{ID: "IT-ACT-01", Priority: "P0", Description: "FinalizeDKGRound: setLatestActiveRound, handleDKGComplete", Expected: "stage=Active, GlobalPublicKey set", Run: runIT_ACT_01, NeedsRoundWait: true},
		...
		{ID: "IT-ACT-05", Priority: "P0", Description: "IsUpgrade round: complete normally", Expected: "IsUpgrade=true, stage=Active", Run: runIT_ACT_05, NeedsRoundWait: true},
		{ID: "IT-ACT-06", Priority: "P0", Description: "First round: settleRewards nil (no prevActive)", Expected: "round 1 has no previous active round", Run: runIT_ACT_06},
		{ID: "IT-ACT-07", Priority: "P0", Description: "DkgCommitteeRewardPortion=0", Expected: "DkgCommitteeRewardPortion value reflects config", Run: runIT_ACT_07},
		{ID: "IT-ACT-08", Priority: "P0", Description: "UBI balance=0: rewards settled", Expected: "active round exists, rewards settled", Run: runIT_ACT_08, NeedsRoundWait: true},
		...
		{ID: "IT-ACT-11", Priority: "P2", Description: "[defensive] PhaseCompleted and IsFinalized: return", Expected: "defensive — unit test only, unreachable in e2e", Run: runIT_ACT_11},
		...
		{ID: "IT-ACT-13", Priority: "P2", Description: "[defensive] dkgSvcRunning true: return", Expected: "defensive — unit test only, Go concurrency lock", Run: runIT_ACT_13},
		{ID: "IT-SKIP-01", Priority: "P2", Description: "Verified < MinReq: SkipToNextRound", Expected: "stage=Failed or new round", Run: runIT_SKIP_01, NeedsRoundWait: true},
		{ID: "IT-SKIP-02", Priority: "P2", Description: "Finalized < MinReq or < Threshold: SkipToNextRound", Expected: "stage=Failed or new round", Run: runIT_SKIP_02, NeedsRoundWait: true},
		{ID: "IT-SKIP-03", Priority: "P0", Description: "FlushAllQueues", Expected: "new round starts clean after state flush", Run: runIT_SKIP_03, NeedsRoundWait: true},
		{ID: "IT-SKIP-04", Priority: "P2", Description: "[defensive] setDKGNetwork(Stage=Failed) fails", Expected: "defensive — unit test only, KV store error unreachable in e2e", Run: runIT_SKIP_04},
		{ID: "IT-E2E-02", Priority: "P0", Description: "Resharing round (non-upgrade)", Expected: "resharing round reaches Active, GlobalPublicKey set", Run: runIT_E2E_02, NeedsRoundWait: true},
		{ID: "IT-E2E-03", Priority: "P0", Description: "Failed round: insufficient Verified", Expected: "stage=Failed, new round starts", Run: runIT_E2E_03, NeedsRoundWait: true},
		{ID: "IT-E2E-04", Priority: "P0", Description: "Failed round: insufficient Finalized", Expected: "stage=Failed, new round starts", Run: runIT_E2E_04, NeedsRoundWait: true},
		{ID: "IT-E2E-05", Priority: "P2", Description: "[needs TEE mock] Complaint / Justification path", Expected: "needs TEE mock to produce invalid deals, currently walks happy path", Run: runIT_E2E_05, NeedsRoundWait: true},
	}
}
...
func p1CDRCases() []TestCase {
	return []TestCase{
		{ID: "IT-CDR-01", Priority: "P0", Description: "FeeCollected → AddCDRFeeToPool, pool balance increases", Expected: "CDRWrite triggers FeeCollected event", NeedsRoundWait: true, Run: runIT_CDR_01},
		{ID: "IT-CDR-02", Priority: "P0", Description: "EncryptedPartialDecryption → IncrementCDRPartialSubmitCount, RefundCDRFee", Expected: "CDRRead triggers decryption events", NeedsRoundWait: true, Run: runIT_CDR_02},
